                ...
                children: [
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          addValueTocartMap(cartmap, Beverages, 'object.2');
                        });
                      },
                      child: const Text(
                        'Add to Cart',
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Mimosa is a kind of plant that can have lovely yellow flowers, '
                      'such as the silver wattle. The color of a mimosa drink, '
                      'usually made with equal parts orange juice and champagne (or other sparkling wines), '
                      'is said to resemble the plant color, hence the name.',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
