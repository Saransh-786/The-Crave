...
class B4 extends StatefulWidget {
  const B4({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Row(
                      ...
                      children: [
                        _buildIconText(
                            Icons.access_time_outlined, Colors.blue, '10 min'),
                        _buildIconText(
                            Icons.star_outlined, Colors.amber, '4.2'),
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          addValueTocartMap(cartmap, Beverages, 'object.4');
                        });
                      },
                      child: const Text(
                        'Add to Cart',
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Espresso is the purest distillation of the coffee bean. '
                      'It does not refer to a bean or blend, but actually the preparation method. '
                      'With an Italian origin, espresso was created because cafes needed a faster way '
                      'to serve coffee to customers. Before espresso, '
                      'it could take up to five minutes to make one cup.',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
