...
class B5 extends StatefulWidget {
  const B5({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          addValueTocartMap(cartmap, Beverages, 'object.5');
                        });
                      },
                      child: const Text(
                        'Add to Cart',
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'A Long Island iced tea or Long Island ice tea is a type of cocktail typically made with vodka, '
                      'tequila, light rum, triple sec, gin, and a splash of cola, '
                      'which gives the drink the same amber hue as iced tea.',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
