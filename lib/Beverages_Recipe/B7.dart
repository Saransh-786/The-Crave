...
class B7 extends StatefulWidget {
  const B7({Key? key}) : super(key: key);

  @override
  State<B7> createState() => _B7State();
}

class _B7State extends State<B7> {
  @override
                ...
                children: [
                  ...
                  Row(
                      ...
                      children: [
                        ...
                        _buildIconText(
                            Icons.star_outlined, Colors.amber, '3.5'),
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          addValueTocartMap(cartmap, Beverages, 'object.7');
                        });
                      },
                      child: const Text(
                        'Add to Cart',
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Mint lemonade is lemonade flavored with mint. '
                      'It may be made with whole mint leaves, mint-flavored syrup, '
                      'or pureed mint leaves, and may be served over ice cubes or '
                      'blended with ice into a slush or smoothie.',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
