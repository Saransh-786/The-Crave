              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'The best of Chinese cuisine right there for you.'
                      ' One of the most popular dish from the cuisine, '
                      'Vegetable hakka noodles is loved by most of the kids and '
                      'what is better than making it at home for them. '
                      'This easy and quick recipe can be made for a light brunch or '
                      'even packed in their tiffin hassle free and without even realizing '
                      'they will be having all the essential vegetables together!'
                      ' Pair it up with dry manchurian for a chinese perfect meal',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
