...
class MN7 extends StatefulWidget {
  const MN7({Key? key}) : super(key: key);

  @override
  State<MN7> createState() => _MN7State();
}

class _MN7State extends State<MN7> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'This is an easy to make Amritsari fish recipe. Fish coated in a batter and deep fried. Garnish with garam masala and lemon juice. Serve hot with mint chutney.',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
