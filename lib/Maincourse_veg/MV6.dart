...
class MV6 extends StatefulWidget {
  const MV6({Key? key}) : super(key: key);

  @override
  State<MV6> createState() => _MV6State();
}

class _MV6State extends State<MV6> {
  @override
                ...
                children: [
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          addValueTocartMap(cartmap, Vegs, 'object.6');
                        });
                      },
                      child: const Text(
                        'Add to Cart',
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Kadhi is a popular north Indian dish, made with besan and yogurt\n '
                      'as main ingredients along with various spices with gram flour pakodas\n '
                      'dipped in it. A popular lunch recipe across all Indian households, \n'
                      'Kadhi is best served along with cooked rice.\n',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
