...
class MV8 extends StatefulWidget {
  const MV8({Key? key}) : super(key: key);

  @override
  State<MV8> createState() => _MV8State();
}

class _MV8State extends State<MV8> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  Row(
                      ...
                      children: [
                        _buildIconText(
                            Icons.access_time_outlined, Colors.blue, '20 min'),
                        _buildIconText(
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          addValueTocartMap(cartmap, Vegs, 'object.8');
                        });
                      },
                      child: const Text(
                        'Add to Cart',
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Craving something rich and creamy? \n'
                      'Then this kaju masala recipe is a must-try.\n '
                      'It is quite a popular gravy in dhabas and often served\n'
                      'with tandoori naan or buttery kulchas\n',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
