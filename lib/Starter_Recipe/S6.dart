                ...
                children: [
                  ...
                  Row(
                      ...
                      children: [
                        ...
                        _buildIconText(
                            Icons.star_outlined, Colors.amber, '4.9'),
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(
                          () {
                            addValueTocartMap(cartmap, Starters, 'object.6');
                          },
                        );
                      },
                      child: const Text(
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Cheesy pasta is a moment; there’s no denying that. '
                      'This comfort food has an unapologetically generous cheese content '
                      'and is also a great source of protein and calcium. '
                      'The best part is the versatility this dish offers — take your '
                      'pick from the various kinds of pasta and combine it with your '
                      'favorite combination of cheeses!',
                      style: TextStyle(
                        fontSize: 18,
                        //color: Colors.black,
                      ),
